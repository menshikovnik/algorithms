...
import cs.course1.tree.BinaryTreePainter;
...
public class TreeDemoFrame extends JFrame {
    ...
    private JButton buttonCountLeftAndRight;
    ...
    public TreeDemoFrame() {
        ...
        buttonCountLeftAndRight.addActionListener(actionEvent -> {
            try {
                SimpleBinaryTree<Integer> tree = new SimpleBinaryTree<>(Integer::parseInt);
                tree.fromBracketNotation(textFieldBracketNotationTree.getText());
                this.tree = tree;
                tree.countingLeftAndRightForEachNode(tree.getTreeRoot());
                tree.displayingCountLeftAndCountRightValues(tree.getTreeRoot());
                textPane1.setText("Количество элементов, для которых надо идти чаще влево, чем вправо:" + " " + tree.resultCountLeft
                        + "\n" + "Количество элементов, для которых надо идти чаще вправо, чем влево:" + " " + tree.resultCountRight);
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        buttonCountLeftAndRight = new JButton();
        buttonCountLeftAndRight.setText("Посчитать количество узлов для которых нужно идти чаще влево, чем вправо и наоборот");
        panel2.add(buttonCountLeftAndRight, new GridConstraints(2, 1, 1, 3, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel4.add(textPane1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
        ...
        panel6.add(buttonToBracketNotation, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(227, 30), null, 0, false));
